...
/*	Modified by Henry Lovett (hl13g10@ecs.soton.ac.uk) to allow SCL frequency to be specified and TWBR calculated
...
#define SCL_Freq		100000		//SCL Frequency in Hertz
#define TWI_TWBR		(char)(F_CPU / 2 / SCL_Freq - 8) //Equation to calculate TWBR Based on SCL Frequency and Clock Frequency

//#define TWI_TWBR            0x0C //400KHz       // TWI Bit rate Register setting.
//#define TWI_TWBR			  0x34 //100KHz                                     // Se Application note for detailed 
